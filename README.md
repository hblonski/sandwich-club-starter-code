...
This app simply loads a JSON file containing information from different sandwiches. The sandwiches are listed, and the user can select one of them to view the details.
